      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tables Data Berita</h1>
                    <p class="mb-4">Data ini digunakan untuk mengelola berita yang ditampilkan di dalam website ini.
                        Anda dapat menambah, mengedit, atau menghapus data berita sesuai kebutuhan.</p>
...
if ($cari != '') {
  $query = mysqli_query($con, "SELECT * FROM berita 
    WHERE judul LIKE '%$cari%' OR isi LIKE '%$cari%' LIMIT $mulai, $halaman") or die(mysqli_error($con));
} else {
